...
class AlignBufferSimSiam():
    ...
    def __init__(self,
        ...
        self.model_name = 'align_buffer_simsiam'
            ...
            for mb_idx, mbatch in tqdm(enumerate(data_loader)):
                ...
                for k in range(self.mb_passes):
                    ...
                    if use_replay:
                        ...
                        loss_align = 0.5*simsiam_loss(aligned_features_1, replay_z_old) + 0.5*simsiam_loss(aligned_features_2, replay_z_old)
